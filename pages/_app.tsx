...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  return <>
    <Head>
      ...
      <meta property="og:image" content="https://ibb.co/ccSXBGs" />
      <meta property="og:image:type" content="image/png" />
      <meta property="og:image:alt" content="https://ibb.co/ccSXBGs" />
      <meta property="thumbnail" content="https://ibb.co/ccSXBGs" />
      <meta property="image" content={'https://ibb.co/ccSXBGs'} />
      <meta property="og:title" content={'Abdulhadi Jarad'} />
      <meta property="og:image:secure" content={'https://ibb.co/ccSXBGs'} />
      <meta property="og:image:url" content={'https://ibb.co/ccSXBGs'} />
