...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  return <>
    <Head>
      ...
      <meta property="og:image" content="https://i.ibb.co/zhTHMyt/avatar.jpg" />
      <meta property="og:image:type" content="image/png" />
      <meta property="og:image:alt" content="https://i.ibb.co/zhTHMyt/avatar.jpg" />
      <meta property="thumbnail" content="https://i.ibb.co/zhTHMyt/avatar.jpg" />
      <meta property="image" content={'https://i.ibb.co/zhTHMyt/avatar.jpg'} />
      <meta property="og:title" content={'Abdulhadi Jarad'} />
      <meta property="og:image:secure" content={'https://i.ibb.co/zhTHMyt/avatar.jpg'} />
      <meta property="og:image:url" content={'https://i.ibb.co/zhTHMyt/avatar.jpg'} />
