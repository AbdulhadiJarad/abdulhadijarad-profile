  ...
  return (
    <section style={style.root}>
        <section className='headingWrapper'>
              <span style={style.myNameIs}><span className='headingNumber'>01.</span> Where I’ve Worked </span> <hr style={style.headingDivider}></hr>
          </section>
          <section style={{color: '#ccd6f6', fontSize: 20}}>
            Engineer <span className='companyName'>@ Amescom</span>
          </section>
